...
- **Donations** - make donations by selecting amounts and billing details
- **Opening hours** - Shows opening times
- **Membership** - Users can sign up or login
- **Amenities** - Food and drink facilities, play area
- **Privacy Policy** - view the museum's privacy policy
...
Search option: 
- Browse available tours/events
  
Booking and reservations: 
- Real-time availability 
- ticket booking (E-tickets)
- Quantity booking options 
- Booking confirmation 'email'
  
User Accounts:  
- Create/login account 
- View booking history (tickets) 
- Modify bookings (dates)
- Save favourite tours/events
...
The project was designed in Figma before we begun development.
You can view the full prototype here:
https://www.figma.com/design/nYnrs2tduoD9Eb9z0nseZC/Untitled?node-id=0-1&t=kobrAr6tjbEpynpJ-1

Images from the Figma:

<img width="1388" height="795" alt="image" src="https://github.com/user-attachments/assets/0fc2fc10-90ee-4677-ac3a-82e13eb58bf4" />

<img width="1286" height="942" alt="image" src="https://github.com/user-attachments/assets/83439b00-8061-49ef-9f46-9722db9e9ef2" />

<img width="1365" height="1004" alt="image" src="https://github.com/user-attachments/assets/3893c929-21c5-4fe0-b675-afcbc3e6750c" />
